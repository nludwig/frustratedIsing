...
class JobLauncher:
  ...
  def makeSbatch(self,lines,jobN,ospfixi,rnList,execInParentDir,data,wpfixi,sweepsMult,kTeff):
    ...
    with open(o,'w') as f:
      ...
      cmd='./MCIsingFIv27_icc_test 1 0 {} {} {} {} {:.4f} {} {} {} {} {} {} {} {} {} {} {} {} {} {}'.format(self.neutralOverall,self.rotation,self.N,self.lStr,self.sigma,self.ewaldIn,paraVal,dataVal,sweepsMult,kTeff,self.enFreq,self.dumpFreq,self.dataFreq,self.suComFreq,self.umbrFreq,self.eSteps,self.pSteps,rnStr,lammpsVal)
